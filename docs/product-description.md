...
| 主要材質 | 第一代：樺木合板（可回收再利用）／第二代：杉木合板 |
| 輔助結構 | 第一代：鋁合金接件／第二代：鋼製結構件 |
| 整幅畫尺寸 | 第一代：1300 × 1030 mm ／ 第二代：1325 × 1035 mm（兩代皆為橫向） |
| 單幅構件 | 小／中／大三種尺寸的椅構件；中椅與大椅共用零件，同時可組出兩把（小＋中 或 小＋大） |
| 獎項 | 2021 當代好設計獎（第一代） |
| 展覽 | 臺中區農業改良場展覽空間（第二代） |
| Instagram | [@painting_chair](https://www.instagram.com/painting_chair) |
| 網站 | https://ziqing-hub.github.io/PaintingChair/ |
...
3. **永續材質（第一代）** — 可回收再利用的樺木合板，質輕耐用（5R 永續原則）
...
環境教育對於兒童的潛移默化影響很大，齊格（1999）發現由大量直線、方塊和矩形組成的新形式，可以極好地激發視覺皮質中的細胞，增加兒童專注力與創意力。

本設計蒙德里安的冷抽象畫作幾何構圖與色彩配置的平面，轉化為立體，採用可回收再利用的樺木合板（第一代），質輕耐用，平面時懸掛於空間中是一幅畫，需要使用時可以從畫中分解出構件，運用顏色與幾何形體組合成一把兒童椅。
...
本設計蒙德里安的冷抽象畫作幾何構圖與色彩配置，轉為立體，藉可回收再利用的樺木合板（第一代），質輕耐用，平面時懸掛於空間成一幅畫，需使用時可從畫中分解出構件，運用顏色與幾何形體組成兒童椅。
...
本設計蒙德里安的冷抽象畫幾何構圖與色彩配置，轉為立體，藉可回收再利用的樺木合板（第一代），質輕耐用，平面時懸掛於空間成一幅畫，需用時可從畫中分解出構件，運用顏色與幾何形體組成兒童椅。
...
Painting Chair translates the geometric composition and color palette of Piet Mondrian's abstract paintings from plane into volume. Crafted from recyclable birch plywood (first generation) — light yet durable — it hangs on the wall as a painting; when needed, components detach from the frame and, guided by color and geometry, assemble into a children's chair.
